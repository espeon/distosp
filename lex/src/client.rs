    ...
    T: atrium_xrpc::XrpcClient + Send + Sync,
{
    ...
    pub(crate) fn new(xrpc: std::sync::Arc<T>) -> Self {
        Self {
            ...
            place: place::Service::new(std::sync::Arc::clone(&xrpc)),
    ...
    T: atrium_xrpc::XrpcClient + Send + Sync,
{
    ...
    pub(crate) fn new(xrpc: std::sync::Arc<T>) -> Self {
        Self {
            stream: place::stream::Service::new(std::sync::Arc::clone(&xrpc)),
            _phantom: core::marker::PhantomData,
        }
    }
}
impl<T> place::stream::Service<T>
where
    T: atrium_xrpc::XrpcClient + Send + Sync,
{
    #[allow(unused_variables)]
    pub(crate) fn new(xrpc: std::sync::Arc<T>) -> Self {
        Self {
            graph: place::stream::graph::Service::new(std::sync::Arc::clone(&xrpc)),
            live: place::stream::live::Service::new(std::sync::Arc::clone(&xrpc)),
            server: place::stream::server::Service::new(std::sync::Arc::clone(&xrpc)),
            _phantom: core::marker::PhantomData,
        }
    }
}
impl<T> place::stream::graph::Service<T>
where
    T: atrium_xrpc::XrpcClient + Send + Sync,
{
    #[allow(unused_variables)]
    ...
    pub async fn get_following_user(
        &self,
        params: crate::place::stream::graph::get_following_user::Parameters,
    ) -> atrium_xrpc::Result<
        crate::place::stream::graph::get_following_user::Output,
        crate::place::stream::graph::get_following_user::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::GET,
                    nsid: crate::place::stream::graph::get_following_user::NSID.into(),
                    parameters: Some(params),
                    input: None,
                    encoding: None,
                },
...
impl<T> place::stream::live::Service<T>
where
    T: atrium_xrpc::XrpcClient + Send + Sync,
{
    #[allow(unused_variables)]
    ...
    pub async fn get_live_users(
        &self,
        params: crate::place::stream::live::get_live_users::Parameters,
    ) -> atrium_xrpc::Result<
        crate::place::stream::live::get_live_users::Output,
        crate::place::stream::live::get_live_users::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::GET,
                    nsid: crate::place::stream::live::get_live_users::NSID.into(),
                    parameters: Some(params),
                    input: None,
                    encoding: None,
                },
    ...
    pub async fn get_profile_card(
        &self,
        params: crate::place::stream::live::get_profile_card::Parameters,
    ) -> atrium_xrpc::Result<
        Vec<u8>,
        crate::place::stream::live::get_profile_card::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::GET,
                    nsid: crate::place::stream::live::get_profile_card::NSID.into(),
                    parameters: Some(params),
                    input: None,
                    encoding: None,
                },
    ...
    pub async fn get_segments(
        &self,
        params: crate::place::stream::live::get_segments::Parameters,
    ) -> atrium_xrpc::Result<
        crate::place::stream::live::get_segments::Output,
        crate::place::stream::live::get_segments::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::GET,
                    nsid: crate::place::stream::live::get_segments::NSID.into(),
                    parameters: Some(params),
                    input: None,
                    encoding: None,
                },
...
impl<T> place::stream::server::Service<T>
where
    T: atrium_xrpc::XrpcClient + Send + Sync,
{
    #[allow(unused_variables)]
    ...
    pub async fn create_webhook(
        &self,
        input: crate::place::stream::server::create_webhook::Input,
    ) -> atrium_xrpc::Result<
        crate::place::stream::server::create_webhook::Output,
        crate::place::stream::server::create_webhook::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::POST,
                    nsid: crate::place::stream::server::create_webhook::NSID.into(),
                    parameters: None,
                    input: Some(atrium_xrpc::InputDataOrBytes::Data(input)),
                    encoding: Some(String::from("application/json")),
                },
    ...
    pub async fn delete_webhook(
        &self,
        input: crate::place::stream::server::delete_webhook::Input,
    ) -> atrium_xrpc::Result<
        crate::place::stream::server::delete_webhook::Output,
        crate::place::stream::server::delete_webhook::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::POST,
                    nsid: crate::place::stream::server::delete_webhook::NSID.into(),
                    parameters: None,
                    input: Some(atrium_xrpc::InputDataOrBytes::Data(input)),
                    encoding: Some(String::from("application/json")),
                },
    ...
    pub async fn get_webhook(
        &self,
        params: crate::place::stream::server::get_webhook::Parameters,
    ) -> atrium_xrpc::Result<
        crate::place::stream::server::get_webhook::Output,
        crate::place::stream::server::get_webhook::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::GET,
                    nsid: crate::place::stream::server::get_webhook::NSID.into(),
                    parameters: Some(params),
                    input: None,
                    encoding: None,
                },
    ...
    pub async fn list_webhooks(
        &self,
        params: crate::place::stream::server::list_webhooks::Parameters,
    ) -> atrium_xrpc::Result<
        crate::place::stream::server::list_webhooks::Output,
        crate::place::stream::server::list_webhooks::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::GET,
                    nsid: crate::place::stream::server::list_webhooks::NSID.into(),
                    parameters: Some(params),
                    input: None,
                    encoding: None,
                },
    ...
    pub async fn update_webhook(
        &self,
        input: crate::place::stream::server::update_webhook::Input,
    ) -> atrium_xrpc::Result<
        crate::place::stream::server::update_webhook::Output,
        crate::place::stream::server::update_webhook::Error,
    > {
        let response = self
            .xrpc
            .send_xrpc::<
            ...
            >(
                &atrium_xrpc::XrpcRequest {
                    method: http::Method::POST,
                    nsid: crate::place::stream::server::update_webhook::NSID.into(),
                    parameters: None,
                    input: Some(atrium_xrpc::InputDataOrBytes::Data(input)),
                    encoding: Some(String::from("application/json")),
                },
